...
-rw------- 1 usr usr 2284 Apr  7 02:07 /etc/kubernetes/kubelet.kubeconfig
$ ls -l /etc/kubernetes/ssl/kubelet*
-rw-r--r-- 1 usr usr 1046 Apr  7 02:07 /etc/kubernetes/ssl/kubelet-client.crt
-rw------- 1 usr usr  227 Apr  7 02:04 /etc/kubernetes/ssl/kubelet-client.key
-rw-r--r-- 1 usr usr 1103 Apr  7 02:07 /etc/kubernetes/ssl/kubelet.crt
-rw------- 1 usr usr 1675 Apr  7 02:07 /etc/kubernetes/ssl/kubelet.key
```
